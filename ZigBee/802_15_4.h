...
#define _SENSOR_INFORMATION
#define get_sensor_info(pstrupacket) fn_netsim_matlab_run((NETWORK->pstruSimulationParameter->dVal)/1000000,(pstruEventDetails->dEventTime)/1000000, 0,0)
#define _SINKNODE_INFORMATION
#define get_sinknode_info(pstrupacket) fn_netsim_matlab_run((NETWORK->pstruSimulationParameter->dVal)/1000000,0, pstruEventDetails->dEventTime/1000000, 1)
